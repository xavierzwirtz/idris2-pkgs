{
  ...
  inputs = {
    ...
    parser = { url = "github:stefan-hoeck/idris2-parser"; flake = false; };
    ...
    quantifiers-extra = { url = "github:stefan-hoeck/idris2-quantifiers-extra"; flake = false; };
    lsp-lib = { url = "github:idris-community/lsp-lib"; flake = false; };
    ansi = { url = "github:idris-community/idris2-ansi"; flake = false; };
    getopts = { url = "github:idris-community/idris2-getopts"; flake = false; };
  };
  ...
  outputs = { self, nixpkgs, idris2, flake-utils, ... }@srcs:
    ...
    flake-utils.lib.eachSystem [ "x86_64-linux" "x86_64-darwin" "i686-linux" ]
      (system:
        ...
        in
        {
          packages = removeAttrs ipkgs ["_builders"];
